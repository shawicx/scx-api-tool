...
| 目录                        | 职责                                                   | 关键文件                                                                                                                                                                                                                                                                                                                    |
| --------------------------- | ------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `src/cli/`                  | CLI 命令与程序入口                                     | `main.ts`（bin 入口）、`program.ts`、`commands/{generate,init,verify,debug,visualize}.ts`、`constants.ts`（默认配置模板）                                                                                                                                                                                                   |
| `src/clients/`              | 插件化 API 数据获取                                    | `base/registry.ts`（注册器）、`base/BaseClient.ts`、`implementations/{SwaggerClient,ApifoxClient}.ts`                                                                                                                                                                                                                       |
| `src/config/`               | 配置文件加载（动态 import 穿透模块缓存 + 5s TTL 缓存） | `loader.ts`                                                                                                                                                                                                                                                                                                                 |
| `src/errors/`               | 分层错误系统                                           | `errorClasses.ts`、`errorCodes.ts`、`errorFactory.ts`                                                                                                                                                                                                                                                                       |
| `src/generator/`            | 代码生成引擎                                           | `index.ts`（`generateCode`）、`codegen.ts`（`generateFiles`）、`extractor.ts`、`fileGenerator.ts`、`fileWriter.ts`、`freeForm.ts`（兼容 re-export，实现在 @/schema/）、`propertyType.ts`                                                                                                                                    |
...
| `src/schema/`               | Schema 中立层（processors 与 generator 共用）          | `freeForm.ts`（free-form 检测、JsonValue）、`operation.ts`（请求体/响应 content 提取）                                                                                                                                                                                                                                      |
